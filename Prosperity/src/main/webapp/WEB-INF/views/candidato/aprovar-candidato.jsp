										...
										<div class="panel panel-default">
											<div class="panel-body">
											 ...
											 <div class="form-group col-md-6">
                                                    <label for="nmEtapa">Tipo da prova</label>
                                                    <select class="form-control" id="nome1" name="nome1">
											...
											<div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="descricao1" name="descricao1" data-required="true" placeholder="">
                                                </div>
											...
											<div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="descricao2"   name="descricao2" data-required="true" placeholder="">
                                                </div>
											...
											<div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="descricao3"  name="descricao3" data-required="true" placeholder="">
                                                </div>
	...
	<div class="modal fade" id="delete-modal" data-target="#delete-modal"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<a class="btn btn-danger" href="${myURL2}">Sim</a>
									...
									<tbody class="text-center">
										<form id="form">
											<c:forEach var="candidato" items="${candidatos}">
												<c:set var="idCandidatoCancelar" value="${candidato.id}" />
												<tr>
														...
														<div class="btn-group">
															...
															<div class="btn-group">
																...
																<ul class="dropdown-menu dropdown-menu-right slidedown">
																	...
																	<li><c:url value="cancelar-candidato/${candidato.id}"
																			var="myURL2">
