...
<body>
	...
	<div class="modal fade" id="aprovado-modal"
		data-target="#aprovado-modal" tabindex="-1" role="dialog"
			...
			<div class="modal-content">
					...
					<tbody class="text-center">
						<tr>
							<td><a href="#" data-toggle="tooltip" data-placement="left"
								title="Somos apaixonados por Inovação e Tecnologia.">
									Desenvolvimento</a></td>
						...
						<tr>
							<td><a href="#" data-toggle="tooltip" data-placement="left"
								title="Nos envolvemos com profundidade em tudo o que fazemos.">
									Profundidade</a></td>
							<td><label class="label-radio inline"> <input
						...
						<tr>
							<td><a href="#" data-toggle="tooltip" data-placement="left"
								title="Traçamos o melhor plano para atingir nosso objetivo.">
									Planejamento</a></td>
							<td><label class="label-radio inline"> <input
						...
						<tr>
							<td><a href="#" data-toggle="tooltip" data-placement="left"
								title="Somos completamente comprometidos em entregar aquilo que prometemos.">
									Execução e entrega</a></td>
							<td><label class="label-radio inline"> <input
						...
						<tr>
							<td><a href="#" data-toggle="tooltip" data-placement="left"
								title="Queremos inspirar e influenciar positivamente.">
									Relacionamento</a></td>
							<td><label class="label-radio inline"> <input
						...
						<tr>
							<td><a href="#" data-toggle="tooltip" data-placement="left"
								title="Cuidamos do nosso time para que ele tenha as melhores oportunidades.">
									Pessoas</a></td>
							<td><label class="label-radio inline"> <input
						...
						<tr>
							<td><a href="#" data-toggle="tooltip" data-placement="left"
								title="Sonhamos grande e vendemos o que acreditamos.">
									Comercial</a></td>
							<td><label class="label-radio inline"> <input
						...
						<tr>
							<td><a href="#" data-toggle="tooltip" data-placement="left"
								title="Buscamos o lucro e trabalhamos para merecê-lo.">
									Financeiro</a></td>
							<td><label class="label-radio inline"> <input
				...
				<div class="form-group">
					<label for="message-text" class="form-control-label"
						style="margin-left: 15px">Parecer técnico:</label>
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-info">
						<i class="fa fa-download fa-lg"></i> Baixar CV
					</button>
			...
			<div class="row">
				<div class="col-sm-12">
					<div class="panel panel-default">
						<div class="panel-heading">Consulta de candidatos - Gestor</div>
									...
									<td>
										<div class="btn-group">
											...
											<ul class="dropdown-menu slidedown">
												<li><a href="historico"><i class="fa fa-eye fa-lg"></i>
														Visualizar</a></li>
												<li class="divider"></li>
												<li><a href="#aprovado-modal" data-toggle="modal"><i
								...
								<tr>
									...
									<td>
										<div class="btn-group">
											...
											<ul class="dropdown-menu slidedown">
												<li><a href="historico-candidato.html"><i
														class="fa fa-eye fa-lg"></i> Visualizar</a></li>
												<li class="divider"></li>
												<li><a href="#aprovado-modal" data-toggle="modal"><i
														class="fa fa-tasks fa-lg"></i> Gestão de candidato</a></li>
									</td>
