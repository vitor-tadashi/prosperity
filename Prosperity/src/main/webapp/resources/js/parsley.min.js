...
function (e) {
  ...
  var t = function (e) {
    this.messages = {
      ...
      type: {
        ...
        user: "O usuário não pode conter espaços ou caracteres especiais."
      },
  ...
  n.prototype = {
    ...
    manageError: function (t) {
      ...
      var n = t.name,
       r = false !== this.options.errorMessage ? "custom-error-message" : n,
       i = {},
       s = false !== this.options.errorMessage ? this.options.errorMessage : t.name === "type" ? this.Validator.messages[n][t.requirements] : "undefined" === typeof this.Validator.messages[n] ? this.Validator.messages.defaultMessage : this.Validator.formatMesssage(this.Validator.messages[n], t.requirements);
    ...
    manageErrorContainer: function () {
      var t = this.options.errorContainer || this.options.errors.container(this.element, this.isRadioOrCheckbox),
       n = this.options.animate ? this.ulTemplate.show() : this.ulTemplate;
      if ("undefined" !== typeof t) {
        e(t).append(n);
        return
  ...
  r.prototype = {
    ...
    bindValidationEvents: function () {
      ...
      this.$element.off("." + this.type);
      var t = this,
       n = (!this.options.trigger ? "" : this.options.trigger) + ((new RegExp("change", "i")).test(this.options.trigger) ? "" : " change");
  ...
  e.fn.parsley = function (t, s) {
    ...
    var o = e.extend(true, {}, e.fn.parsley.defaults, "undefined" !== typeof window.ParsleyConfig ? window.ParsleyConfig : {}, t, this.data()),
     u = null;
