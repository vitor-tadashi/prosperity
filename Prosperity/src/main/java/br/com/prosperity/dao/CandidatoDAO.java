...
public class CandidatoDAO extends GenericDAOImpl<CandidatoEntity, Integer> {
	...
	protected List<CandidatoEntity> findByCriteria(String propertyOrder, Boolean isDesc, final int firstResult,
	...
	public List<CandidatoEntity> listarAprovacao(List<Integer> listaStatus, Integer statu, Integer idUsuario,
			Integer idStatusCandidatura, Integer page) {
	...
	public float countAprovacao(List<Integer> listaStatus, Integer statu, Integer idUsuario,
			Integer idStatusCandidatura) {
		Long result = null;
